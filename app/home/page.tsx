...
const featuredProjects = [
  {
    ...
    description:
      "A modern hospitality website designed to increase direct inquiries and showcase the property experience.",
  },
  {
    title: "Business Presence Website",
    description:
      "A clean digital presence for a growing company seeking stronger online credibility.",
  },
  {
    title: "Health Coaching Website",
    description:
      "A professional personal website for services, bookings, and trust-building.",
  },
] as const;
